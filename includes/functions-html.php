...
function yourls_html_logo() {
	...
	?>
	<h1>
		<a href="http://urlslice.me" title="Urlslice.me"><span>URL</span><span></span>Slice<span>.me</span><br/>
		<img src="<?php yourls_site_url(); ?>/images/yourls-logo.png" alt="urlslice.me" title="YOURLS" border="0" style="border: 0px;" /></a>
	</h1>
	<?php
...
function yourls_html_head( $context = 'index', $title = '' ) {
	...
	// Page title
	$_title = 'Urlslice.me &mdash; URL Shortener | ' . yourls_link();
